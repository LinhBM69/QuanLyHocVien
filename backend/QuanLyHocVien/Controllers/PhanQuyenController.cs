...
namespace QuanLyHocVien.Controllers
{
  ...
  {
    private readonly IPhanQuyenServicer iServicer;
    public PhanQuyenController(IPhanQuyenServicer iServicer)
    {
    ...
    [HttpPost]
    public IActionResult Post(PhanQuyen taiKhoan)
    {
    ...
    [HttpPut]
    public IActionResult Put(PhanQuyen taiKhoan)
    {
